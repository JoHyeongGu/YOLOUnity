...
public class YoloPose
{
    ...
    public List<YoloPosePrediction> Predict(Unity.InferenceEngine.Tensor<float> outputTensor, int imageWidth, int imageHeight)
    {
        Unity.InferenceEngine.ComputeTensorData computeTensorData = Unity.InferenceEngine.ComputeTensorData.Pin(outputTensor);
